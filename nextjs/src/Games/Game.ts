...
export class Game {
    ...
    initPoints = () => {
        switch (this.type) {
            ...
            case "djmania":
                var boxCount = 4;
                let xStartPoint = ((this.canvas.vmax - this.canvas.vmin) / 2) / this.canvas.width
    ...
    draw = () => {
        ...
        switch (this.type) {
            ...
            case 'djmania':
                ...
                const startPoint = (this.canvas.vmax - this.canvas.vmin) / 2
                for (var i = 0; i < 5; i++) {
        ...
        ctx.fillText(this.combo.toString(), .5 * this.canvas.width, .3 * this.canvas.height);
        ctx.closePath()
