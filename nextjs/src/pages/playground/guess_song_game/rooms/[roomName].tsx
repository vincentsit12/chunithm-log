                ...
                {isHost &&
                    <div id="guess-song-game-host" className=''>
                        ...
                        {selectedGameType.value == GuessSongGameType.playlist && <div className='flex my-5'>
                            ...
                            }>{isLoadingSongList ? <div role="status">
                        ...
                        <div className='flex my-5 items-center'>
                            <div className='flex-1'>
                                ...
                                {selectedGameType.value != GuessSongGameType.custom && <button disabled={!canControlGamePanel} className='btn btn-secondary my-1' onClick={getNextSong}>Next</button>}
                            </div>
